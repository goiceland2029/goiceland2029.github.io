	...
	var PicmanInit = {
		...
		portfolioPopup: function(){
			...
			button.off().on('click',function(){
				...
				modalBox.find('.popup_details').prepend('<div class="top_image"><img src="assets/image/4-2.jpg" alt="" /><div class="main" data-img-url="'+image+'"></div></div>');
...
//			  	direction: "vertical",
		...
		blogModal: function(){
			...
			button.on('click',function(){
				...
				modalBox.addClass('opened');
				modalBox.find('.description_wrap').html(content);
				modalBox.find('.news_popup_informations').prepend('<div class="image"><img src="assets/image/4-2.jpg" alt="" /><div class="main" data-img-url="'+image+'"></div></div>');
		...
		serviceModal: function(){
			...
			button.on('click',function(){
				...
				modalBox.addClass('opened');
				modalBox.find('.description_wrap').html(content);
				modalBox.find('.service_popup_informations').prepend('<div class="image"><img src="assets/image/4-2.jpg" alt="" /><div class="main" data-img-url="'+elImage+'"></div></div>');
				PicmanInit.BgImg();
